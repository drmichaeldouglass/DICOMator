...
- **RT Structure Set output**
  ...
  - ROIs with multiple loops on any slice use `CLOSEDPLANAR_XOR` for every contour in that ROI, preserving holes regardless of loop winding. Other ROIs use `CLOSED_PLANAR`.
